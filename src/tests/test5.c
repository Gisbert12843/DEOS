...
#include "progs.h"
#if defined(TESTTASK_ENABLED) && TESTTASK == 5
...
void stage2()
{
  ...
  // Fill stack as much as it can
  volatile uint8_t data[STACK_SIZE_PROC - 63] = {0}; //  If "stack pointer error" occurs, make `data` smaller until it fits
